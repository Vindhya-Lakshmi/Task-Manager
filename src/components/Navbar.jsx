...
const Navbar = ({ user = {}, onLogout }) => {
  ...
  return (
    <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-md shadow-sm border-b border-gray-200 font-sans">
      <div className="flex items-center justify-between px-4 py-3 md:px-6 max-w-6xl mx-auto">
        {/* Left - Logo */}
        <div
        ...
        <div className="flex items-center gap-4">
          ...
          <div ref={menuref} className="relative">
            ...
            {/* Dropdown List */}
            {menuOpen && (
              <ul className="absolute top-14 right-0 w-52 bg-white rounded-2xl shadow-xl border border-purple-100 z-50 overflow-hidden animate-fadeIn">
                <li className="p-2">
                  <button
                    onClick={() => {
                      setMenuOpen(false);
